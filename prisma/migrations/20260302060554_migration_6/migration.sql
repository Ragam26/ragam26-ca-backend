...
-- AddForeignKey
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_referral_code_fkey" FOREIGN KEY ("referral_code") REFERENCES "users"("phone_no") ON DELETE SET NULL ON UPDATE CASCADE;
